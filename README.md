...
<img src="docs/screenshot-light.png" alt="Agent Monitor — Light Mode" width="100%">
<br><br>
<img src="docs/screenshot-dark.png" alt="Agent Monitor — Dark Mode" width="100%">
...
- 📋 **Current task** — Latest task label extracted from session data
...
- [ ] Phase 2 — 暂停 / 终止 Agent Session
- [ ] Phase 2 — 实时日志抽屉（读取 transcript JSONL）
- [ ] Phase 3 — macOS 系统托盘应用（Tauri）
